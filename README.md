...
2. Используя Selenium, напишите сценарий для автоматизации процесса перехода на нужную страницу сайта [code]([../homeworks/hw_7_selenium.py](https://github.com/KonstantinMerenkov/CollectData/blob/main/hw_7_selenium.py)).
...
4. Используйте BeautifulSoup для парсинга содержимого HTML и извлечения нужной информации из идентифицированных элементов [code](https://github.com/KonstantinMerenkov/CollectData/blob/main/hw_7_bs.py).
